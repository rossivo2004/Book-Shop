                ...
                <div class="fl-left">
                    ...
                    <?php
                            if (isset($_SESSION['tb']) && ($_SESSION['tb'] != ""))
                                ...
                                unset($_SESSION['tb']);
                            ?>
                    <form action="index.php?pg=logincheck" method="post">
                        ...
                        <div class="btn-login">
                            <input type="submit" name="dangnhapcheck"  value="Đăng nhập">
                        </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="rg-email">
                            <div class="rg-email__input">
                                <div class="input-group">
                                    <input required="" type="text" name="email" autocomplete="off" class="input input-login-register input-email">
                                    <label class="user-label">Email</label>
                                    <i class="fa-solid fa-envelope"></i>
                                  </div>
                            </div>
                            <div class="err-user_name">
                                <small class="hide">Vui lòng nhập email</small>
                            </div>
                        </div>
                        <div class="rg-password">
                            <div class="rg-password__input">
                                <div class="input-group">
                                    <input required="" type="password" name="password" autocomplete="off" class="input input-login-register input-password rg-password_input">
                                    <label class="user-label">Mật khẩu</label>
                                    <i class="fa-solid fa-eye showPassword" ></i>
                                  </div>
                            </div>
                            <div class="err-password">
                                <small class="hide rg-err">Mật khẩu không đủ 8 kí tự</small>
                            </div>
                        </div>
                        <div class="rg-password_confirm">
                            <div class="rg-passwordConfirm__input">
                                <div class="input-group">
                                    <input required="" type="password" name="repassword" autocomplete="off" class="input input-login-register input-password rg-password_confirm__input">
                        ...
                        <div class="err-password">
                            <small class="hide rg-err__2">Mật khẩu không trùng khớp</small>
                        </div>
                        </div>
